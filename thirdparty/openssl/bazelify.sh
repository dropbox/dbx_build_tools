...
make include/openssl/opensslconf.h crypto/include/internal/bn_conf.h crypto/include/internal/dso_conf.h apps/progs.h
...
echo -e "BN_CONF_H = \"\"\"$(grep ^# crypto/include/internal/bn_conf.h)\"\"\"\n" >> "$mydir/BUILD.openssl"
echo -e "DSO_CONF_H = \"\"\"$(grep ^# crypto/include/internal/dso_conf.h)\"\"\"\n" >> "$mydir/BUILD.openssl"
