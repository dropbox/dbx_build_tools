...
DEFAULT_EXTERNAL_URLS = {
    ...
    "go_1_16_3_linux_amd64_tar_gz": ["https://dl.google.com/go/go1.16.3.linux-amd64.tar.gz"],
    ...
    "org_sqlite": ["https://sqlite.org/2021/sqlite-amalgamation-3350500.zip"],
...
def drte_deps(urls = DEFAULT_EXTERNAL_URLS):
    ...
    http_archive(
        name = "go_1_16_3_linux_amd64_tar_gz",
        urls = urls["go_1_16_3_linux_amd64_tar_gz"],
