...
DEFAULT_EXTERNAL_URLS = {
    ...
    "mypy": ["https://github.com/python/mypy/archive/d887e9c0d090694b66b5fa20ac249b3d749a8518.tar.gz"],
...
def pypi_core_deps(urls = DEFAULT_EXTERNAL_URLS):
    ...
    http_archive(
        name = "mypy",
        urls = urls["mypy"],
        sha256 = "87334a63a0a907fefc5fc30a80db18677ea5dea4745764777cf63d36d2310cd4",
        strip_prefix = "mypy-d887e9c0d090694b66b5fa20ac249b3d749a8518",
